...
<body>
    ...
    <ul>
      ...
      <li><a class="active" href="parent_reminder.php">Reminder</a></li>
            ...
            <div class="fresh-table full-color-orange ">
                ...
                <table id="fresh-table" class="table">
                    <thead>
                        ...
                        <th data-field="vaccination_date" data-sortable="true">Next vaccination date</th>
                    ...
                    <tbody>
                        ...
                        JOIN vaccines ON requests.vaccine_id = vaccines.id
                         WHERE parents.id = $logged_in_parent  ;
                        ";
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                if ($reminder_status == 'Sent' || $reminder_status == 'Acknowledged') {
                        ?>
                                    <tr>
                                        ...
                                        <td><a href="parent_booking.php" style="color:brown">Book</a></td>
                                    </tr>
                        <?php
                                }
                            }
    ...
    <!-- footer include -->
     ...
     <!-- footer end -->
      <script src="assets/js/dropdown_parent"></script>
