...
if (!isset($_SESSION['parent_id'])) {
    header("Location: parents_login.php"); // Redirect to login page if not logged in
    exit();
}
...
<body>
    ...
    <ul>
      ...
      <li><a class="active" href="parent_vaccination_report.php">vaccination reports</a></li>
    ...
    <main>
        <div class="tablename">Vaccination Reports</div>
        <div class="wrapper">
...
";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row=mysqli_fetch_assoc($result)) {
                                $id = $row['vaccination_report_id'];
                                $child_name = $row['child_name'];
                                $age = $row['age'];
                                $gender = $row['gender'];
                                $status = $row['vaccination_report_status'];
                                ...
                                // Do nothing. This is just a placeholder for a custom condition.
                        ?>
                                <tr>
